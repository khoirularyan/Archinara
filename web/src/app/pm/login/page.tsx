  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-0 bg-white rounded-2xl shadow-2xl overflow-hidden">
        {/* Left Side - Branding */}
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-12 flex flex-col justify-between text-white relative overflow-hidden">
          {/* Decorative circles */}
          ...
          <div className="relative z-10">
            <a href="/pm" className="inline-block mb-12">
              <span className="text-3xl font-bold">Archinara <span className="text-blue-200">PM</span></span>
            </a>
            ...
            <p className="text-blue-100 text-lg mb-8">
              Kelola proyek arsitektur Anda dengan lebih efisien. Pantau progres, kolaborasi tim, dan kelola dokumen dalam satu platform.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Manajemen Proyek Real-time</h3>
                  <p className="text-blue-100 text-sm">Pantau progres proyek secara langsung</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-blue-400 flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">Bekerja bersama dalam satu platform</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-blue-400 flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Dokumen Terpusat</h3>
                  <p className="text-blue-100 text-sm">Akses semua file proyek dengan mudah</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 text-blue-100 text-sm">
            © 2025 Archinara PM. All rights reserved.
          </div>
        </div>
        ...
        <div className="p-12 flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-slate-600">Masukkan kredensial Anda untuk melanjutkan</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="/pm/forgot-password" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                Lupa password?
              </a>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-slate-600">
            Belum punya akun?{" "}
            <a href="/pm/signup" className="text-blue-600 hover:text-blue-700 font-semibold">
              Daftar sekarang
            </a>
          </p>
        </div>
