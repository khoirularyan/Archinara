      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-30">
        <div className="h-full px-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Link href="/pm/dashboard" className="flex items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* User Menu */}
            <div className="relative profile-dropdown pl-4 border-l border-gray-200">
              {session?.user && (
                <>
                  <button
                    onClick={() => setShowProfileMenu(!showProfileMenu)}
                    className="flex items-center gap-3 text-gray-700 hover:text-gray-900 transition-colors focus:outline-none"
                  >
                    {session.user.image ? (
                      <Image
                  ...
                  {showProfileMenu && (
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                      ...
                      <button
                        ...
                        className="flex items-center gap-3 w-full px-4 py-2 text-sm text-red-600 hover:bg-gray-50 transition-colors text-left"
                      >
                        <svg
                          className="w-4 h-4"
                          fill="none"
